function openEstimateSection() {
    ...
    "<div style='display: flex; justify-content: space-around; margin-top: 0'>" + "<div style='border: 1px white solid; margin: 20px; padding-left: 10px; padding-right: 10px;' class='fromTo'>" +
     "<h2 style='color: white; font-size: 25px;'>From</h2>" + "<div>" + "<h2 style='color: white; font-size: 20px;'>Address:</h2>" + "<input style='width:250px;' type='text' id='postalCode' name='Postal Code'>" + "</div>" + "<div>" + "<h2 style='color: white; font-size: 20px;'>Country:</h2>" + "<h3 style='color: white; font-size: 20px;'>Canada*</h3>" + "</div>" +
    ...
    "</div>" + "</div>" + "<form style='border: 1px solid white; margin-left: 35px;     margin-right: 35px; padding: 30px;'>" + "<h1 style='font-size: 25px; color: white;'>Info</h1>" +
      ...
      "<input style='width:125px; text-align: center; type='phone' id='phone' name='phone'><br><br>" +
      "<button style='width: 200px; height: 40px; cursor: pointer; font-size: 25px; position: relative; left: 33%;' onclick='calculate()'><b>Calculate</b></button>" +
      "</form>" + "</section>";
